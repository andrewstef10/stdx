...
{
    EXPECT_TRUE(stdads::within_exclusive(5, 1, 10));
    EXPECT_TRUE(stdads::within_exclusive(-5, -10, -1));
}

TEST(WithinExclusiveTests, ValueOnLowerBound)
{
    EXPECT_FALSE(stdads::within_exclusive(1, 1, 10));
    EXPECT_FALSE(stdads::within_exclusive(-10, -10, -1));
}

TEST(WithinExclusiveTests, ValueOnUpperBound)
{
    EXPECT_FALSE(stdads::within_exclusive(10, 1, 10));
    EXPECT_FALSE(stdads::within_exclusive(-1, -10, -1));
}

TEST(WithinExclusiveTests, ValueBelowRange)
{
    EXPECT_FALSE(stdads::within_exclusive(0, 1, 10));
    EXPECT_FALSE(stdads::within_exclusive(-11, -10, -1));
}

TEST(WithinExclusiveTests, ValueAboveRange)
{
    EXPECT_FALSE(stdads::within_exclusive(11, 1, 10));
    EXPECT_FALSE(stdads::within_exclusive(0, -10, -1));
}
...
{
    EXPECT_FALSE(stdads::outside_inclusive(5, 1, 10));
    EXPECT_FALSE(stdads::outside_inclusive(-5, -10, -1));
}

TEST(OutsideExclusiveTests, ValueOnLowerBound)
{
    EXPECT_TRUE(stdads::outside_inclusive(1, 1, 10));
    EXPECT_TRUE(stdads::outside_inclusive(-11, -10, -1));
}

TEST(OutsideExclusiveTests, ValueOnUpperBound)
{
    EXPECT_TRUE(stdads::outside_inclusive(10, 1, 10));
    EXPECT_TRUE(stdads::outside_inclusive(-1, -10, -1));
}

TEST(OutsideExclusiveTests, ValueBelowRange)
{
    EXPECT_TRUE(stdads::outside_inclusive(0, 1, 10));
    EXPECT_TRUE(stdads::outside_inclusive(-11, -10, -1));
}

TEST(OutsideExclusiveTests, ValueAboveRange)
{
    EXPECT_TRUE(stdads::outside_inclusive(11, 1, 10));
    EXPECT_TRUE(stdads::outside_inclusive(0, -10, -1));
}
